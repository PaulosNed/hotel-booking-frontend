    ...
    <div className="md:w-8/12 mx-auto px-10">
      <div className="flex flex-col space-y-16">
        <div className="flex flex-col items-center space-y-10">
          <h1 className="text-4xl font-bold font-montserrat">Description</h1>
        ...
        <Link href={'/reserve/1'} className="self-center btn text-white w-fit">Book Now for ${room.price.toString()}</Link>
      </div>
    </div>
  );
};
